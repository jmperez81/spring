 ...
 * - Además, nos piden que si se produce una excepción se mande un correo.
 * - Además, piden que sólo puedan utilizarla administradores en todos los métodos
 * - Ahora nos piden que lo hagamos para cualquier clase del proyecto... ¿? ¡dolor! -> aspectos
 * - Y no sólo ahí sino en librerías terceras.... ¿??? no se puede sin aspectos!
 */
